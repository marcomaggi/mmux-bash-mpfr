...
MMUX_BASH_BUILTIN_MAIN([[[$1]]])
{
  ...
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_RND([[[rnd]]],	[[[4]]]);
  {
    ...
    value	= $1(&exp, op, rnd);
    rv = mmux_$2_bind_to_bash_variable(argv[1], value, MMUX_BASH_BUILTIN_STRING_NAME);
    if (MMUX_SUCCESS != rv) {
      return rv;
    } else {
      return mmux_slong_bind_to_bash_variable(argv[2], exp, MMUX_BASH_BUILTIN_STRING_NAME);
    }
  }
}
MMUX_BASH_DEFINE_TYPICAL_BUILTIN_FUNCTION([[[$1]]],
...
MMUX_BASH_BUILTIN_MAIN([[[mpfr_frexp]]])
{
  mpfr_ptr		op1, op2;
  mpfr_rnd_t		rnd;
  ...
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_RND([[[rnd]]],	[[[4]]]);
  {
    ...
    rv      = mmux_bash_mpfr_set_MPFR_RV(rv_mpfr, MMUX_BASH_BUILTIN_STRING_NAME);
    if (MMUX_SUCCESS == rv) {
...
MMUX_BASH_BUILTIN_MAIN([[[mpfr_get_str]]])
{
  int		base;
  size_t	ndigits;
  mpfr_ptr	op;
  ...
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_USIZE([[[ndigits]]],	[[[4]]]);
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_PTR([[[op]]],	[[[5]]]);
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_RND([[[rnd]]],	[[[6]]]);
  {
    ...
    if (str) {
      int	rv = mmux_string_bind_to_bash_variable(argv[1], str, MMUX_BASH_BUILTIN_STRING_NAME);
      mpfr_free_str(str);
      if (MMUX_SUCCESS != rv) {
	return rv;
      } else {
	return mmux_mpfr_exp_bind_to_bash_variable (argv[2], exp, MMUX_BASH_BUILTIN_STRING_NAME);
      }
    }
...
m4_define([[[DEFINE_PREDICATE_FOR_GETTERS]]],[[[MMUX_BASH_BUILTIN_MAIN([[[mpfr_fits_$1_p]]])
{
  mpfr_ptr	op;
  mpfr_rnd_t	rnd;
...
MMUX_BASH_BUILTIN_MAIN([[[mpfr_get_z_2exp]]])
{
  mpz_ptr	rop;
  mpfr_ptr	op;

  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPZ_PTR([[[rop]]],	[[[2]]]);
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_PTR([[[op]]],	[[[3]]]);
  {
...
MMUX_BASH_BUILTIN_MAIN([[[mpfr_get_z]]])
{
  mpz_ptr	rop;
  mpfr_ptr	op;
  mpfr_rnd_t	rnd;

  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPZ_PTR([[[rop]]],	[[[1]]]);
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_PTR([[[op]]],	[[[2]]]);
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_RND([[[rnd]]],	[[[3]]]);
  {
...
MMUX_BASH_BUILTIN_MAIN([[[mpfr_get_q]]])
{
  mpq_ptr	rop;
  mpfr_ptr	op;
...
MMUX_BASH_BUILTIN_MAIN([[[mpfr_get_f]]])
{
  mpf_ptr	rop;
  mpfr_ptr	op;
  mpfr_rnd_t	rnd;

  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPF_PTR([[[rop]]],	[[[1]]]);
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_PTR([[[op]]],	[[[2]]]);
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_RND([[[rnd]]],	[[[3]]]);
  {
...
MMUX_BASH_BUILTIN_MAIN([[[mpfr_get_str_ndigits]]])
{
  mmux_sint_t	B;
  mpfr_prec_t	prec;

  MMUX_BASH_PARSE_BUILTIN_ARGNUM_SINT([[[B]]],		[[[2]]]);
  MMUX_BASH_PARSE_BUILTIN_ARGNUM_MPFR_PREC([[[prec]]],	[[[3]]]);
  {
    mmux_ssize_t	rv = mpfr_get_str_ndigits(B, prec);
    return mmux_ssize_bind_to_bash_variable(argv[1], rv, MMUX_BASH_BUILTIN_STRING_NAME);
  }
}
